...
export default function ForgotPasswordPage() {
    ...
    return (
        <main className="flex flex-col min-h-screen w-full bg-brand-dark relative overflow-x-hidden">
            <NotificationToast
                    ...
                    <div className="w-full max-w-md text-white">
                        ...
                        <form className="space-y-2" onSubmit={handleReset}>
                            <div className="space-y-1.5">
                                <Label className="text-base font-heading font-semibold opacity-90" htmlFor="email">
                                    Email Address
                                </Label>
                                <Input
                                    id="email"
