                ...
                <div className="max-w-2xl w-full text-white">
                    <div className="mb-7">
                        ...
                        <p className="mt-4 text-sm text-gray-400 break-words leading-relaxed">
                            Please check email <span className="text-white font-medium">{email}</span> to see your OTP code.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleVerify} className="space-y-4">
                        ...
                        <div className="flex flex-col sm:flex-row justify-between gap-2">
                            ...
                            <button
                                ...
                                className="text-[#FC3436] text-sm font-semibold hover:brightness-90 disabled:opacity-50 text-right cursor-pointer"
                            >
