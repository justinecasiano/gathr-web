        ...
        <div className="flex relative h-screen w-full flex-col bg-[#F7F0FF] overflow-hidden">
            ...
            <main
                ...
                <div className="flex-1 mt-2 space-y-4 overflow-y-auto custom-scrollbar">
                    ...
                    {(currentItems.length > 0 || showSkeleton) && currentItems.map((event) => (
                        <Skeleton
                            key={event.id}
                            ...
                            className={cn(showSkeleton && "rounded-[14px] bg-white/40 shadow-sm border border-transparent hover:border-[#5C5C5C] transition-all")}
                            color="#574272"
