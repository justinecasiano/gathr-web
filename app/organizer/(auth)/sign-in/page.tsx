                ...
                <div className="max-w-2xl w-full text-white">
                    <div className="mb-10">
                        ...
                        <p className="mt-4 text-sm text-[#888888]">
                            Please log in to access the <span className="font-semibold">organizer</span> account.
                        </p>
                    </div>
                    ...
                    <p className="mt-8 text-center text-sm font-bold text-[#202C4D]">
                        Are you a Moderator?{" "}
                        <Link href="/moderator/sign-in" className="text-[#202C4D] font-medium underline underline-offset-3">
                            Switch to Moderator
                        </Link>
                    </p>
                </div>
