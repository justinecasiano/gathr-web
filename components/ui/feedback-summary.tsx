...
export function FeedbackSummary({eventId}: { eventId: number }) {
    ...
    return (
        <Card
            className="border-2 border-[#5C5C5C] shadow-[12px_12px_0px_0px_rgba(87,66,114,1)] rounded-2xl p-6 print:block print:shadow-none print:border-slate-300 print:overflow-visible print:mb-8">
            ...
            <div
                className="relative bg-gradient-to-b from-[#6C41A3] to-[#473163] rounded-[20px] py-6 px-8 text-white flex justify-between items-center print:break-inside-avoid">
                <div>
                    <h4 className="text-xl font-bold font-display mb-2">Summary of Feedback<br/>for this event</h4>
                    <Skeleton
            ...
            <div className="space-y-6 max-h-[470px] overflow-y-auto print:max-h-none print:overflow-visible print:block">
