    ...
    return (
        <div
            ...
            <div className="flex items-start gap-6">
                <div className={cn(
                    "relative h-25 w-25 shrink-0 overflow-hidden",
                )}>
                ...
                <div className="flex-1">
                    <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center gap-x-5 gap-y-2 flex-wrap">
                            <h3 className="text-2xl font-heading font-bold text-black truncate max-w-[300px] lg:max-w-[650px] shrink-0">{fullName}</h3>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-y-3 font-heading font-normal text-black">
                        <div className="flex items-center gap-3">
                            ...
                            <span
                                className="text-xl truncate max-w-[700px] inline-block align-bottom">{eventLocation}</span>
                        </div>
                    </div>
                </div>
            </div>
