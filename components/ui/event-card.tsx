...
export function EventCard({
    ...
    return (
        <div className="flex flex-col w-full gap-3 rounded-[14px] bg-white shadow-sm border border-transparent hover:border-[#5C5C5C] transition-all">
                ...
                <div className="flex flex-1 flex-col gap-2 min-w-0">
                    ...
                    <div className="grid grid-cols-1 gap-y-3 font-heading font-normal text-black">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-bold text-[#FC3436] text-base inline-block align-bottom">{attendees}</span>
                        </div>
                    </div>
                </div>
